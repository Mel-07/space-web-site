      ...
      dataTech.map((v,i)=>(
        ...
        <div className=' flex lg:justify-end   '>
        {
         ...
         <div className=' min-w-[100%]'>
           <img className={`${windowWidth >= 764 ? ' object-cover w-[100%] lg:w-[515px] lg:h-[527px]' : 'object-cover min-w-[100%] h-full'}`} loading='lazy' src={windowWidth >= 764 ? technologyImage[techSliderIndex].portrait_img :technologyImage[techSliderIndex].landScape_img } alt="" />
         </div>
        }
        </div>
      </div>
